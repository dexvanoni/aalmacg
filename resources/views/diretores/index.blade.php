...
@section('content')
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Lista de Diretores <a style="color: green" title="Novo Diretor" href="{{route('diretor.create')}}"><i class="fas fa-plus-circle"></i></a></div>
                        ...
                        <tbody>
                            @foreach ($diretores as $s)
                                <tr>
                                    ...
                                    <td>{{$s->funcao}}</td>
                                    <td>
                                       <a style="margin-right: 5px" title="EDITAR" href="{{route('diretor.edit', $s->id)}}">
                                        <i style="color: blue" class="fas fa-user-edit"></i>
                                       </a>

                                       <!--<a title="IMPRIMIR CARTEIRINHA" href="{{route('diretor.show', $s->id)}}">
